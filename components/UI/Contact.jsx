        ...
        <Row className="flex justify-between flex-col md:flex-row ">
          <Col lg="4" md="6">
            ...
            <ul className={`${classes.contact__info__list}`}>
              ...
              <li className={`${classes.info__item}`}>
                <span>
                  <a href="mailto:codewithsony@gmail.com">
                    <i className="ri-mail-line"></i>
                  </a>
                </span>
                <p>
                  <a href="mailto:codewithsony@gmail.com">
                   codewithsony@gmail.com
                  </a>
                </p>
              </li>
            </ul>
            ...
            <div className={`${classes.social__links}`}>
              ...
              <Link
                ...
                href="https://github.com/codewithsonyy"
                target="_blank"
              >
                <RiGithubFill />
              </Link>
              <Link
                ...
                href="https://twitter.com/Soni_react"
                target="_blank"
              >
                <RiTwitterFill />
              </Link>
              <Link
                ...
                href="https://www.linkedin.com/in/soniiyy/"
                target="_blank"
              >
                <RiLinkedinFill />
              </Link>
