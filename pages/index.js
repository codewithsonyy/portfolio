...
export default function Home({
  ...
  return (
    <Fragment>
      <Head>
        {/* <!-- Primary Meta Tags --> */}
        <title>Soni Kumari - Dev and Learner</title>
        ...
        <meta property="og:url" content="https://www.sonikumari.dev" />
        <meta property="og:title" content="Soni Kumari - Dev and Learner" />
        <meta
          property="og:description"
          content="Hi there! My name is Soni Kumari and I’m a web developer with over 2 years of experience in the industry. I love all things tech and coding, and on my channel, I share my knowledge and experience with others."
        />
        <meta
          property="og:image"
        ...
        <meta
          ...
          content="Soni Kumari - Dev and Learner"
        />
        <meta
